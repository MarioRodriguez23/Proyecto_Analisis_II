...
<body>
	...
	<div class="containerTable">
		...
		<?php
			//Paginador
			$sql_registe = mysqli_query($conection,"SELECT COUNT(*) as total_registro FROM cliente c INNER JOIN paciente p WHERE c.estatus = 1 ");
			...
			$query = mysqli_query($conection,"SELECT* FROM cliente c
			INNER JOIN paciente p On c.codpaciente = p.codpaciente
		WHERE c.estatus = 1 ORDER BY c.idcliente ASC LIMIT $desde,$por_pagina
				");
