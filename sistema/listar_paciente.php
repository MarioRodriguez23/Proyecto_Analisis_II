...
<body>
	...
	<div class="containerTable">
		...
		<?php
			//Paginador
			$sql_registe = mysqli_query($conection,"SELECT COUNT(*) as total_registro FROM paciente WHERE estatus = 1 ");
			...
			$query = mysqli_query($conection,"SELECT codpaciente, nombrep, dpi, edad, fechacita, hora, estado  FROM paciente 
                                                      WHERE estatus = 1 ORDER BY codpaciente ASC LIMIT $desde,$por_pagina 
				");
