	...
	if(!empty($_POST))
	{
		...
		if(empty($_POST['codpaciente']))
		{
			...
			$observacion    = $_POST['observacion'];
				...
				$query_insert = mysqli_query($conection,"INSERT INTO fichaf(codpaciente,motivo,medico,examen,resultado,diagnostico,medicamento1,aplicacion1,medicamento2,aplicacion2,medicamento3,aplicacion3,observacion)
	...
	<section id="container">
		...
		<div class="form_register">
			...
			<form action="" method="post">
				...
				<select name="medico">
					<option disabled selected>Seleccionar Medico</option>
				...
				<select name="examen">
					<option disabled selected>Seleccionar Examen</option>
