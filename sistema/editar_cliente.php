<?php 
	...
	{
		$alert='';
		if(empty($_POST['nombre']) || empty($_POST['telefono']) || empty($_POST['direccion']) || empty($_POST['codpaciente']))
		{
			...
			if($result > 0){
				...
				$sql_update = mysqli_query($conection,"UPDATE cliente
															SET nit = $nit, nombre='$nombre',telefono='$telefono',direccion='$direccion',codpaciente='$codpaciente'
	...
	<section id="container">
		...
		<div class="form_register">
			...
			<form action="" method="post">
				...
				<label for="direccion">Código Paciente</label>
				<input type="number" name="codpaciente" id="codpaciente" placeholder="Actualizar paciente" value="<?php echo $codpaciente; ?>">
