	...
	<table id="factura_head">
		<tr>
			...
			<td class="info_empresa">
				<div>
					<span class="h2">SISTEMA VENTAS FARMACIA</span>
					<p>Ciudad Guatemala Zona 14, Guatemala</p>
					<p>Teléfono: +(502) 4721-9575</p>
					<p>Email: lratzanr@miumg.edu.gt</p>
				</div>
			</td>
			...
			<td class="info_cliente">
				<div class="round">
					...
					<table class="datos_cliente">
						<tr>
							<td><label>Nit:</label><p>9575124</p></td>
							<td><label>Teléfono:</label> <p>78024521</p></td>
						</tr>
						<tr>
