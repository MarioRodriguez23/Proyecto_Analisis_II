...
<body>
	...
	<div class="containerTable">
		...
		<?php
			//Paginador
			$sql_registe = mysqli_query($conection,"SELECT COUNT(*) as total_registro FROM fichaf f
			inner join paciente p WHERE f.estatus = 1  ");
			...
			$query = mysqli_query($conection,"SELECT f.ficha, p.codpaciente, p.nombrep, f.fecha, f.examen, f.resultado, f.diagnostico, f.medicamento1, f.medicamento2, f.medicamento3  FROM fichaf f
				...
				<tr>
					...
					<td>
						<a class="link_edit" href="editar_ficha.php?id=<?php echo $data["ficha"]; ?>"><i class="far fa-edit"></i> Editar</a>
							|
						<a class="link_delete" href="eliminar_confirmar_ficha.php?id=<?php echo $data["ficha"]; ?>"><i class="far fa-trash-alt"></i> Eliminar</a>
