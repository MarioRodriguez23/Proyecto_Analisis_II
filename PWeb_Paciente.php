...
<head>
    ...
    <link rel="stylesheet" href="css/PWcss_Paciente.css">
    <meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0">

</head>
<body>
    <header>
        <h1 class="titulo">Centro Medico Asilo de Ancianos <span>Guatemala</span></h1>
    </header>
...
<!-- Contenedor de Imagenes .hover -->
<div class="junto">
        <div class="container">
            <div class="caja">
                <img src="img/Anciano1.jpg">
                <span>Salud</span>
            </div>
            <div class="caja">
                <img src="img/Anciano2.jpg">
                <span>Examenes</span>
            </div>
            <div class="caja">
                <img src="img/Anciano3.jpg">
                <span>Citas Médicas</span>
            </div>
            <div class="caja">
                <img src="img/anciano4.jpeg">
                <span>Bienestar</span>
            </div>
        </div>
    
    <footer class="footer">
        <p>Todos los derechos reservados. Luis Mario Freelancer</p>
    </footer>
</div>
