...
<head>
	...
	<title>Login | Sistema Centro Médico</title>
...
<body>
	<section id="container">
		<form action="" method="post">
			...
			<img src="img/login02.png" width="250 px" alt="Login">
			...
			<div class="visitar_sitio">
				<a href="PWeb_index.php">Visita nuestro sitio web</a>
			</div>
